...
const CourseInformation:FC<Props> = ({courseInfo, setCourseInfo, active, setActive}) => {
    ...
    return (
        <div className='w-[80%] m-auto mt-24 h-100vh'>
            <form onSubmit={handleSubmit} className={`${styles.label}`}>
                ...
                <div className='mb-5'>
                    ...
                    <textarea name='' id='' cols={30} rows={10} placeholder='Write something interesting...'
                ...
                <div>
                    ...
                    <input
                        ...
                        id='tags'
                        placeholder='MERN, Next 13, TailwindCSS, Express.js'
                        className={`${styles.input}`}
                    />
                </div>
                <br/>
                    ...
                    >
                        {
                            courseInfo.thumbnail ? (
                                <img src={courseInfo.thumbnail} alt="courseInfo"
